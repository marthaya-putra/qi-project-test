...
@Injectable()
export class UserSearchService implements SearchTermService {
    ...
    public getTerms(value:string):Observable<SearchTerm[]> {
        let url = `https://api.instagram.com/v1/users/search?q=${value}&access_token=${this.authService.getToken()}&count=10&callback=JSONP_CALLBACK`;
